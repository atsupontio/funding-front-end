      ...
      <div className="siderContent">
        <div className="menu">
          <div className="details">
            <Icon fill="#141d26ed" size={33} svg="twitter" />
          </div>

          <Link to="/" className="link">
            <div className="menuItems">
              <Icon fill="#141d26ed" size={33} svg="list" />
              Post
            </div>
          </Link>
          ...
          <Link to="/vote" className="link">
            <div className="menuItems">
              <Icon fill="#141d26ed" size={33} svg="checkmark" />
              Vote
            </div>
          </Link>
          ...
          <Link to="/profile" className="link">
            <div className="menuItems">
              <Icon fill="#141d26ed" size={33} svg="user" />
              Profile
            </div>
          </Link>
          ...
          <Link to="/settings" className="link">
            <div className="menuItems">
              <Icon fill="#141d26ed" size={33} svg="cog" />
              Settings
            </div>
          </Link>
        </div>
